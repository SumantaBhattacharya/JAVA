...
public class MultiThreading5 {
    public static void main(String[] args) {// main method will call the JVM to terminate
        ...
        T2.interrupt();
        // whenever we are getting t2 it giving us an interrupt
        // it isstill showing T1 after the exception
        String n = Thread.currentThread().getName();
        for (int i = 1; i <= 3; i++) {
            System.out.println(i);
            System.out.println(n);
        }
        // we are having a problem in synchronisation thats we are getting corrupted
        // output
